...
public class AmPmCirclesView extends View {
    ...
    public void initialize(Context context, int amOrPm) {
        ...
        mUnselectedColor = res.getColor(R.color.opt_dtpicker_white);
        mSelectedColor = res.getColor(R.color.opt_dtpicker_blue);
        mAmPmTextColor = res.getColor(R.color.opt_dtpicker_ampm_text_color);
        ...
        mCircleRadiusMultiplier =
                Float.parseFloat(res.getString(R.string.opt_dtpicker_circle_radius_multiplier));
    ...
    /* package */ void setTheme(Context context, boolean themeDark) {
        Resources res = context.getResources();
        if (themeDark) {
            mUnselectedColor = res.getColor(R.color.opt_dtpicker_dark_gray);
            // kman mSelectedColor = res.getColor(R.color.blue);
            mSelectedColor = res.getColor(R.color.opt_dtpicker_blue_dark);
            mAmPmTextColor = res.getColor(R.color.opt_dtpicker_white);
