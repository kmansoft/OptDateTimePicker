...
public class RadialTextsView extends View {
	...
	public void initialize(Resources res, String[] texts, String[] innerTexts, boolean is24HourMode,
		...
		if (is24HourMode) {
			mCircleRadiusMultiplier = Float.parseFloat(res.getString(R.string.opt_dtpicker_circle_radius_multiplier_24HourMode));
		} else {
			mCircleRadiusMultiplier = Float.parseFloat(res.getString(R.string.opt_dtpicker_circle_radius_multiplier));
			mAmPmCircleRadiusMultiplier = Float.parseFloat(res.getString(R.string.opt_dtpicker_ampm_circle_radius_multiplier));
		}
		...
		if (mHasInnerCircle) {
			mNumbersRadiusMultiplier = Float.parseFloat(res.getString(R.string.opt_dtpicker_numbers_radius_multiplier_outer));
			mTextSizeMultiplier = Float.parseFloat(res.getString(R.string.opt_dtpicker_text_size_multiplier_outer));
			mInnerNumbersRadiusMultiplier = Float.parseFloat(res.getString(R.string.opt_dtpicker_numbers_radius_multiplier_inner));
			mInnerTextSizeMultiplier = Float.parseFloat(res.getString(R.string.opt_dtpicker_text_size_multiplier_inner));

			mInnerTextGridHeights = new float[7];
			mInnerTextGridWidths = new float[7];
		} else {
			mNumbersRadiusMultiplier = Float.parseFloat(res.getString(R.string.opt_dtpicker_numbers_radius_multiplier_normal));
			mTextSizeMultiplier = Float.parseFloat(res.getString(R.string.opt_dtpicker_text_size_multiplier_normal));
		}
...
//        final ColorStateList colorPrimary = a.getColorStateList(0);
		...
		mPaint.setColor(colorSecondary.getDefaultColor());
	}
	...
	public void onDraw(Canvas canvas) {
		...
		if (mTextGridValuesDirty) {
			...
			if (mHasInnerCircle) {
				...
				calculateGridSizes(innerNumbersRadius, mXCenter, mYCenter, mInnerTextSize, mInnerTextGridHeights,
	...
	private void renderAnimations() {
		...
		PropertyValuesHolder radiusDisappear = PropertyValuesHolder.ofKeyframe("animationRadiusMultiplier", kf0, kf1,
				kf2);
		...
		mReappearAnimator = ObjectAnimator.ofPropertyValuesHolder(this, radiusReappear, fadeIn).setDuration(
				totalDuration);
