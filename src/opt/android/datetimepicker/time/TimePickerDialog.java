...
import opt.android.datetimepicker.time.RadialPickerLayout.OnValueSelectedListener;
...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public static final int HOUR_INDEX = RadialPickerLayout.HOUR_INDEX;
    public static final int MINUTE_INDEX = RadialPickerLayout.MINUTE_INDEX;
    // NOT a real index for the purpose of what's showing.
    public static final int AMPM_INDEX = RadialPickerLayout.AMPM_INDEX;
    // Also NOT a real index, just used for keyboard mode.
    public static final int ENABLE_PICKER_INDEX = RadialPickerLayout.ENABLE_PICKER_INDEX;
    public static final int AM = RadialPickerLayout.AM;
    public static final int PM = RadialPickerLayout.PM;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.opt_dtpicker_time_picker_dialog, null);
        KeyboardListener keyboardListener = new KeyboardListener();
        view.findViewById(R.id.time_picker_dialog).setOnKeyListener(keyboardListener);

        Resources res = getResources();
        mHourPickerDescription = res.getString(R.string.opt_dtpicker_hour_picker_description);
        mSelectHours = res.getString(R.string.opt_dtpicker_select_hours);
        mMinutePickerDescription = res.getString(R.string.opt_dtpicker_minute_picker_description);
        mSelectMinutes = res.getString(R.string.opt_dtpicker_select_minutes);
        mSelectedColor = res.getColor(mThemeDark? R.color.opt_dtpicker_red : R.color.opt_dtpicker_blue);
        mUnselectedColor = res.getColor(mThemeDark? R.color.opt_dtpicker_white : R.color.opt_dtpicker_numbers_text_color);
        ...
        mDoneButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCallback != null) {
                    mCallback.onTimeSet(TimePickerDialog.this,
        ...
        mDeletedKeyFormat = res.getString(R.string.opt_dtpicker_deleted_key);
        ...
        int white = res.getColor(R.color.opt_dtpicker_white);
        int circleBackground = res.getColor(R.color.opt_dtpicker_circle_background);
        int line = res.getColor(R.color.opt_dtpicker_line_background);
        int timeDisplay = res.getColor(R.color.opt_dtpicker_numbers_text_color);
        ColorStateList doneTextColor = res.getColorStateList(R.color.opt_dtpicker_done_text_color);
        int doneBackground = R.drawable.opt_dtpicker_done_background_color;

        int darkGray = res.getColor(R.color.opt_dtpicker_dark_gray);
        int lightGray = res.getColor(R.color.opt_dtpicker_light_gray);
        int darkLine = res.getColor(R.color.opt_dtpicker_line_dark);
        ColorStateList darkDoneTextColor = res.getColorStateList(R.color.opt_dtpicker_done_text_color_dark);
        int darkDoneBackground = R.drawable.opt_dtpicker_done_background_color_dark;
