...
public class CircleView extends View {
	...
	public CircleView(Context context) {
		...
		mCircleColor = res.getColor(R.color.opt_dtpicker_white);
		mDotColor = res.getColor(R.color.opt_dtpicker_numbers_text_color);
	...
	public void initialize(Context context, boolean is24HourMode) {
		...
		if (is24HourMode) {
			mCircleRadiusMultiplier = Float.parseFloat(res
					.getString(R.string.opt_dtpicker_circle_radius_multiplier_24HourMode));
		} else {
			...
			mAmPmCircleRadiusMultiplier = Float.parseFloat(res
					.getString(R.string.opt_dtpicker_ampm_circle_radius_multiplier));
		}
	...
	/* package */void setTheme(Context context, boolean dark) {
		Resources res = context.getResources();
		if (dark) {
			mCircleColor = res.getColor(R.color.opt_dtpicker_dark_gray);
			mDotColor = res.getColor(R.color.opt_dtpicker_light_gray);
		} else {
			mCircleColor = res.getColor(R.color.opt_dtpicker_white);
			mDotColor = res.getColor(R.color.opt_dtpicker_numbers_text_color);
		}
