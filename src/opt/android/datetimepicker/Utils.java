...
public class Utils {
    ...
    // kman
    public static final int[] COLOR_ATTRS = {android.R.attr.textColorPrimaryDisableOnly, android.R.attr.textColorSecondary };
    public static final int[] DISABLED_STATE_SET = { -android.R.attr.state_enabled };
    
    public static boolean isThemeDark(int colorPrimaryDefault) {
    	 final boolean isDarkTheme = 
         		(colorPrimaryDefault & 0xFF) +
         		((colorPrimaryDefault >>> 8) & 0xFF) +
         		((colorPrimaryDefault >>> 16) & 0xFF) >= 0x80 * 3; 
         return isDarkTheme;
    }
