...
import opt.android.datetimepicker.date.MonthAdapter.CalendarDay;
...
public class DatePickerDialog extends DialogFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.opt_dtpicker_date_picker_dialog, null);
        ...
        mDayPickerDescription = res.getString(R.string.opt_dtpicker_day_picker_description);
        mSelectDay = res.getString(R.string.opt_dtpicker_select_day);
        mYearPickerDescription = res.getString(R.string.opt_dtpicker_year_picker_description);
        mSelectYear = res.getString(R.string.opt_dtpicker_select_year);
