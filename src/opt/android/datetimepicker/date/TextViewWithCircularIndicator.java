...
public class TextViewWithCircularIndicator extends TextView {
    ...
    public TextViewWithCircularIndicator(Context context, AttributeSet attrs) {
        ...
        mCircleColor = res.getColor(R.color.opt_dtpicker_blue);
        mRadius = res.getDimensionPixelOffset(R.dimen.opt_dtpicker_month_select_circle_radius);
        mItemIsSelectedText = context.getResources().getString(R.string.opt_dtpicker_item_is_selected);
